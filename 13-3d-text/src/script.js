...
fontLoader.load('/fonts/helvetiker_regular.typeface.json', font => {
    ...
    // bevelSize 会影响x,y的坐标中心 bevelThickness会影响到z
    textGeo.translate(-(textGeo.boundingBox.max.x - 0.02) * 0.5, -(textGeo.boundingBox.max.y - 0.02) * 0.5, -(textGeo.boundingBox.max.z - 0.03) * 0.5);
    // textGeo.center();
